...
export default function HomeHeroSection() {
  ...
  return (
    <section className="bg-gray-100 py-10 px-5 flex flex-col gap-10 items-center">
      ...
      <div key={4041} className="w-full grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-5 relative max-w-screen-xl m-auto">
