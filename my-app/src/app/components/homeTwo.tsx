            ...
            return (
              <div key={index} className="min-h-[300px] flex flex-col justify-between bg-white p-5 rounded-xl">
                <div>
                  ...
                  <span className="text-gray-500">{card.carType}</span>
                </div>
                <div className="flex sm:flex-col flex-row gap-5 text-right justify-between sm:text-left">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <span className="font-bold">{card.carPrice}</span>/day
                  </div>
                  <a href="/Products">
                    <button
                      type="button"
